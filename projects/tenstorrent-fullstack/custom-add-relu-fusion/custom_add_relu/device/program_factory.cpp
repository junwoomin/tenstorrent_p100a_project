...
ProgramDescriptor AddReluDeviceOperation::create_descriptor(
    ...
    compute.kernel_source = kernel_dir + "compute.cpp";
    ...
    TensorAccessorArgs(*out_buffer).append_to(writer_compile_args);
    KernelDescriptor writer;
    writer.kernel_source = kernel_dir + "writer.cpp";
    ...
    for (uint32_t i = 0; i < num_cores; ++i) {
        ...
        writer.emplace_runtime_args(core, {out_buffer, count, start_tile});
        start_tile += count;
    }
